...
|--- main
|---- java
|----- com.ascendcorp.DefaultGenerator.java // generator file
|---- resources
...
```
java -cp /path/to/swagger-codegen-distribution:/path/to/your/jar io.swagger.codegen.Codegen -l default -o ./test
```
...
java -DdebugOperations -cp /path/to/swagger-codegen-distribution:/path/to/your/jar io.swagger.codegen.Codegen -l default -o ./test
```
